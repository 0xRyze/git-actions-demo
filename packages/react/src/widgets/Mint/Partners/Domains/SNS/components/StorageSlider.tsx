...
const StorageSlider: React.FC<Props> = ({ size, setSize, onOpen, onClose, isOpen, loading, subTotalPrice }) => {
  return (
    <Flex mt="2" justifyContent={'space-between'}>
      <Flex alignItems={'center'}>
        ...
        <Text textDecoration={'underline'} fontSize={'12'} cursor={'pointer'} onClick={onOpen}>
          Edit
        </Text>
      </Flex>
